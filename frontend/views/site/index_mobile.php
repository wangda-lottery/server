...
<div class="" id="innerbox">
    <div class="header">
        <div class="logo"><h1><a href="https://zcwqhb1.com/#" class=""><img src="./images/logo.png" alt=""></a></h1></div>
    </div>
    <div class="content">
        <div class="baobox">
            <div class="shengyu">
                ...
                <div class="cl"></div>
                <div class="juhd">
                    <div class=""><span class="" id="hb-clock-d">0</span><em class="">天</em></div>
                    <div class=""><span class="" id="hb-clock-h">0</span><em class="">小时</em></div>
                    <div class=""><span class="" id="hb-clock-m">0</span><em class="">分</em></div>
                    <div class=""><span class="" id="hb-clock-s">0</span><em class="">秒</em></div>
                </div>
            </div>
            <div class="cl "></div>
            <div class="luntiwa">
                <div class="luntop luntop2">
                    <ul id="announce" style="top: -736px;">
                    </ul>
                </div>
            </div>
            <div class="cl h20"></div>
            <div class="">
                <!-- <a href="/index.php?s=/Home/Index/detail.html" class="chakna" ><img src="/Public/static/hb/mb/images/chakan.png" alt="" /></a> -->
            </div>
    ...
    <div class="nav df ac js">
        <a href="https://40997a.com/register" class="">
            <span class="nvig"><img src="./images/nv2cur.png" alt=""></span>快速开户
        </a>
        <a href="javascript:;" onclick="showQueryWin();" class="">
            <span class="nvig"><img src="./images/nv3cur.png" alt=""></span>红包查询
        </a>
        <a href="https://40997a.com/mobilee" class="">
            <span class="nvig"><img src="./images/nv4cur.png" alt=""></span>手机投注
        </a>
        <a href="https://vue.comm100.com/chatWindow.aspx?siteId=5000346&planId=730" class=""><span class="nvig">
            <img src="./images/nv6cur.png" alt=""></span>在线客服
        </a>
    </div>
...
<!-- 领取窗口 start -->
<div class="tanchuceng" id="getWin" style="display:none;  z-index:99999999">
...
<div id="hongbao_open" class="popup flip" style="display:none;">
    <div class="popup-t"><a href="javascript:;" onclick="close_hongbao(this)" class="b1"><img src="./images/x.png"></a>
        <p class="b2"><img src="./images/logo.png" width="210"></p>
        <p class="b3"></p>
        <p class="b4">&nbsp;&nbsp;</p>
        <p class="b5" id="b5">恭喜发财，大吉大利!</p>
        <a href="javascript:;" id="openpacket" onclick="getPacket()" class="b6">拆红包</a></div>
